...
namespace saaToKml
{
    class Program
    {
        ...
        static StreamWriter moa = new StreamWriter("moa.kml");
        static StreamWriter controlled = new StreamWriter("controlled.kml");
        static StreamWriter prohibited = new StreamWriter("prohibited.kml");
        static StreamWriter restricted = new StreamWriter("restricted.kml");
        static StreamWriter alert = new StreamWriter("alert.kml");
        static StreamWriter warning = new StreamWriter("warning.kml");
        static StreamWriter national = new StreamWriter("national.kml");

        static StreamWriter saaLocation = new StreamWriter("saaLocation.txt");
        static StreamWriter saaGeometry = new StreamWriter("saaGeometry.txt");
        static StreamWriter saaTimes = new StreamWriter("saaTimes.txt");
        static StreamWriter saaNote = new StreamWriter("saaNote.txt");
        ...
        static List<String> pos = new List<String>();
        ...
        static void Main(string[] args)
        {
            ...
            if (args.Length == 0)
            {
                WriteDocumentStart(moa);
                WriteDocumentStart(controlled);
                WriteDocumentStart(prohibited);
                WriteDocumentStart(restricted);
                WriteDocumentStart(alert);
                WriteDocumentStart(warning);
                WriteDocumentStart(national);

                foreach (ZipArchiveEntry entry in archive.Entries)
                {
                    entry.ExtractToFile("temp.xml", true);

                    StreamWriter sw = controlled;
                ...
                WriteDocumentEnd(moa);
                WriteDocumentEnd(controlled);
                WriteDocumentEnd(prohibited);
                WriteDocumentEnd(restricted);
                WriteDocumentEnd(alert);
                WriteDocumentEnd(warning);
                WriteDocumentEnd(national);
        ...
        static void WriteLineStringSegment(StreamWriter kml)
        {
            ...
            kml.WriteLine("      <extrude>1</extrude>");
            kml.WriteLine("      <tessellate>1</tessellate>");
            kml.WriteLine("      <altitudeMode>relativeToGround</altitudeMode>");
