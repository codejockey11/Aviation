...
IF EXIST "weather.tif" ( CALL "%PYTHONHOME%\Scripts\gdal2tiles.bat" -z 4-9 -w google -r average -s EPSG:4326 -g AIzaSyCnoazHa0WEibhtQZmBqlMtXcr9LOjN5Dw weather.tif "public_html\charts\weather" )
