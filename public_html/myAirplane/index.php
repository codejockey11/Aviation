...
<tr>
  ...
  <td>
  <input name="plane" id="plane" type="text" size="10" onclick="ToggleDropdownVisibility('aircraftDropdownDiv');" value="<?php echo $plane;?>" readonly />
<?php
...
<div id="aircraftDropdownDiv" style="
	background-color:rgb(211, 211, 211);
	border:1px solid rgb(11, 83, 148);
	border-radius:3px;
	font-family:Verdana;
	font-size:12px;
	font-weight:normal;
...
printf("<td class=\"leftMidLabel\"><button id=\"closeAircraft\" name=\"closeAircraft\" class=\"smallButton\" onclick=\"ToggleDropdownVisibility('aircraftDropdownDiv');\">Close</button></td>");
