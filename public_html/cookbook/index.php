...
function AddRecipe()
{
	...
	if ($_POST["ingrediant0000"])
	{
		$d->ExecSql(sprintf("INSERT INTO cbIngredients (title, name) VALUES ('%s','%s')", $_POST["title"], $_POST["ingrediant0000"]));
	}
	if ($_POST["ingrediant0001"])
	{
		$d->ExecSql(sprintf("INSERT INTO cbIngredients (title, name) VALUES ('%s','%s')", $_POST["title"], $_POST["ingrediant0001"]));
	}
	if ($_POST["ingrediant0002"])
	{
		$d->ExecSql(sprintf("INSERT INTO cbIngredients (title, name) VALUES ('%s','%s')", $_POST["title"], $_POST["ingrediant0002"]));
	}
	if ($_POST["ingrediant0100"])
	{
		$d->ExecSql(sprintf("INSERT INTO cbIngredients (title, name) VALUES ('%s','%s')", $_POST["title"], $_POST["ingrediant0100"]));
	}
	if ($_POST["ingrediant0101"])
	{
		$d->ExecSql(sprintf("INSERT INTO cbIngredients (title, name) VALUES ('%s','%s')", $_POST["title"], $_POST["ingrediant0101"]));
	}
	if ($_POST["ingrediant0102"])
	{
		$d->ExecSql(sprintf("INSERT INTO cbIngredients (title, name) VALUES ('%s','%s')", $_POST["title"], $_POST["ingrediant0102"]));
	}
	if ($_POST["ingrediant0200"])
	{
		$d->ExecSql(sprintf("INSERT INTO cbIngredients (title, name) VALUES ('%s','%s')", $_POST["title"], $_POST["ingrediant0200"]));
	}
	if ($_POST["ingrediant0201"])
	{
		$d->ExecSql(sprintf("INSERT INTO cbIngredients (title, name) VALUES ('%s','%s')", $_POST["title"], $_POST["ingrediant0201"]));
	}
	if ($_POST["ingrediant0202"])
	{
		$d->ExecSql(sprintf("INSERT INTO cbIngredients (title, name) VALUES ('%s','%s')", $_POST["title"], $_POST["ingrediant0202"]));
	}
	if ($_POST["ingrediant0300"])
	{
		$d->ExecSql(sprintf("INSERT INTO cbIngredients (title, name) VALUES ('%s','%s')", $_POST["title"], $_POST["ingrediant0300"]));
	}
	if ($_POST["ingrediant0301"])
	{
		$d->ExecSql(sprintf("INSERT INTO cbIngredients (title, name) VALUES ('%s','%s')", $_POST["title"], $_POST["ingrediant0301"]));
	}
	if ($_POST["ingrediant0302"])
	{
		$d->ExecSql(sprintf("INSERT INTO cbIngredients (title, name) VALUES ('%s','%s')", $_POST["title"], $_POST["ingrediant0302"]));
	}
	if ($_POST["ingrediant0400"])
	{
		$d->ExecSql(sprintf("INSERT INTO cbIngredients (title, name) VALUES ('%s','%s')", $_POST["title"], $_POST["ingrediant0400"]));
	}
	if ($_POST["ingrediant0401"])
	{
		$d->ExecSql(sprintf("INSERT INTO cbIngredients (title, name) VALUES ('%s','%s')", $_POST["title"], $_POST["ingrediant0401"]));
	}
	if ($_POST["ingrediant0402"])
	{
		$d->ExecSql(sprintf("INSERT INTO cbIngredients (title, name) VALUES ('%s','%s')", $_POST["title"], $_POST["ingrediant0402"]));
	}
	if ($_POST["ingrediant0500"])
	{
		$d->ExecSql(sprintf("INSERT INTO cbIngredients (title, name) VALUES ('%s','%s')", $_POST["title"], $_POST["ingrediant0500"]));
	}
	if ($_POST["ingrediant0501"])
	{
		$d->ExecSql(sprintf("INSERT INTO cbIngredients (title, name) VALUES ('%s','%s')", $_POST["title"], $_POST["ingrediant0501"]));
	}
	if ($_POST["ingrediant0502"])
	{
		$d->ExecSql(sprintf("INSERT INTO cbIngredients (title, name) VALUES ('%s','%s')", $_POST["title"], $_POST["ingrediant0502"]));
	}
...
function WriteAddForm()
{
	...
	printf("</tr>\r\n");
	printf("<tr><td colspan=\"3\">Ingrediants</td></tr>\r\n");
	...
	for($row = 0;$row < 6;$row++)
	{
		...
		for($col = 0;$col < 3;$col++)
		{
			printf("<td><input type=\"text\" name=\"ingrediant" . sprintf("%02d%02d", $row, $col) . "\" class=\"inputText\" value=\"\"/></td>\r\n");
		}
...
function WriteUpdateForm($selection)
{
	...
	if ($selection)
	{
		...
		if ($d->GetRowCount() > 0)
		{
			while($row = $d->FetchRow())
			{
				array_push($ingrediants, $row["name"]);
			}
		}
	...
	for($row = 0;$row < 6;$row++)
	{
		...
		for($col = 0;$col < 3;$col++)
		{
			if(($c < count($ingrediants)) && (count($ingrediants) > 0))
			{
				printf("<td><input type=\"text\" name=\"ingrediant" . sprintf("%02d%02d", $row, $col) . "\" class=\"inputText\" value=\"" . $ingrediants[$c] . "\"/></td>\r\n");
			}
			else
			{
				printf("<td><input type=\"text\" name=\"ingrediant" . sprintf("%02d%02d", $row, $col) . "\" class=\"inputText\" value=\"\"/></td>\r\n");
