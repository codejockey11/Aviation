...
<table class="mainForm"><tr><td>
  ...
  <td>
    ...
    <tr><td class="rightLabel">Ground Speed</td><td><input size="5" name="speed" type="text" id="speed"/></td></tr>
    <tr><td class="rightLabel">Feet per NM</td><td><input size="5" name="fpnm" type="text" id="fpnm"/></td></tr>
    <tr><td class="rightLabel">Rate Of Climb</td><td><input readonly size="5" name="roc" type="text" id="roc"/></td></tr>
    ...
    <tr><td class="rightLabel">Ground Speed</td><td><input size="5" name="speed" type="text" id="speed"/></td></tr>
    <tr><td class="rightLabel">Glide Slope Angle</td><td><input size="5" name="gsa" type="text" id="gsa"/></td></tr>
    <tr><td class="rightLabel">Rate Of Decent</td><td><input readonly size="5" name="rod" type="text" id="rod"/></td></tr>
    ...
    <tr><td class="rightLabel">Altitude</td><td><input size="5" name="altitude" type="text" id="altitude"/></td></tr>
    <tr><td class="rightLabel">Final Altitude</td><td><input size="5" name="faltitude" type="text" id="faltitude"/></td></tr>
    <tr><td class="rightLabel">Vertical FPM</td><td><input size="5" name="fpm" type="text" id="fpm"/></td></tr>
    <tr><td class="rightLabel">Ground Speed</td><td><input size="5" name="speed" type="text" id="speed"/></td></tr>
    <tr><td class="rightLabel">Distance (nm.)</td><td><input readonly size="5" name="distance" type="text" id="distance"/></td></tr>
    ...
    <tr><td class="rightLabel">Temperature</td><td><input size="5" name="temp" type="text" id="temp"/></td></tr>
    <tr><td class="rightLabel">Dew Point</td><td><input size="5" name="dp" type="text" id="dp"/></td></tr>
    <tr><td class="rightLabel">Cloud Base</td><td><input readonly size="5" name="cb" type="text" id="cb"/></td></tr>
    <tr>
...
?>
  ...
  <tr>
    ...
    <tr><td class="rightLabel">Wind Direction</td><td><input size="5" name="windDir" type="text" id="windDir"/></td></tr>
    <tr><td class="rightLabel">Wind Speed</td><td><input size="5" name="windSpeed" type="text" id="windSpeed"/></td></tr>
    <tr><td class="rightLabel">Airspeed</td><td><input size="5" name="airspeed" type="text" id="airspeed"/></td></tr>
    <tr><td class="rightLabel">Desired Course</td><td><input size="5" name="course" type="text" id="course"/></td></tr>
    <tr><td class="rightLabel">Correction</td><td><input readonly size="5" name="correction" type="text" id="correction"/></td></tr>
    <tr><td class="rightLabel">Ground Speed</td><td><input readonly size="5" name="groundspeed" type="text" id="groundspeed"/></td></tr>
    ...
    <tr><td style="text-align:center" colspan="2">(FAA Format)</td></tr>
    <tr><td class="rightLabel">Latitude</td><td><input size="25" name="latitude" type="text" id="latitude" /></td></tr>
    <tr><td class="rightLabel">Longitude</td><td><input size="25" name="longitude" type="text" id="longitude" />
	</td></tr>
    <tr><td class="rightLabel">GPS</td><td style="min-width:333px;max-width:333px;"><input readonly size="40" name="gps" type="text" id="gps"/></td></tr>
    ...
    <table class="e6b200px">
    <tr><th colspan="2">Approach Ratio</th></tr>
    <tr><td class="rightLabel">Vertical Distance</td><td><input size="5" name="vdist" type="text" id="vdist"/></td></tr>
    <tr><td class="rightLabel">Horizontal Distance</td><td><input size="5" name="hdist" type="text" id="hdist"/></td></tr>
    <tr><td class="rightLabel">Glide Angle</td><td><input readonly size="5" name="gslope" type="text" id="gslope"/></td></tr>
    <tr><td>&nbsp;</td><td><input type="submit" value="Calc" id="Submit" class="button" onclick="ApproachRatio()"/></td></tr>
    </table>
    </form>
    </td>
...
<tr>
	...
	<table class="e6bda">
	<tr><th colspan="2">Density Altitude (from NOAA)</th></tr>
	<tr>
...
?>
	...
	<tr>
		<td>
			<input class="button" type="button" onclick="DAConvert(document.form8.Temp.value, document.form8.StatPress.value, document.form8.Dewpoint.value)" value="Calc" />
		</td>
