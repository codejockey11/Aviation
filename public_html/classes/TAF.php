...
class TAF
{
	...
	public function __construct($station)
	{
		...
		$xml = sprintf("http://www.aviationweather.gov/adds/dataserver_current/httpparam?&dataSource=tafs&timeType=valid&requestType=retrieve&format=xml&mostRecent=true&hoursBeforeNow=1&stationString=%s", $station);
