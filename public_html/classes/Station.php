...
class Station
{
	...
	public function __construct($ident)
	{
		...
		$xml = sprintf("http://www.aviationweather.gov/adds/dataserver_current/httpparam?dataSource=stations&requestType=retrieve&format=xml&stationString=%s", $ident);
		...
		// get the metars
		$xml = sprintf("http://www.aviationweather.gov/adds/dataserver_current/httpparam?dataSource=metars&requestType=retrieve&format=xml&hoursBeforeNow=1&stationString=%s", $ident);
