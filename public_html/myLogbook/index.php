...
if (isset($_POST["printd"]))
{
	printf("<script>window.location='../myLogbook/print.php?id=%s&ord=D'</script>\r\n", $sess->sessionId);
}

if (isset($_POST["printa"]))
{
	printf("<script>window.location='../myLogbook/print.php?id=%s&ord=A'</script>\r\n", $sess->sessionId);
}
...
<tr>
  <td><input type="text" size="20" name="flightDateTime" value="<?php echo $flightDateTime;?>" /></td>
...
<td>
  ...
  <input type="submit" value="Print Desc" name="printd" class="button" />
  <input type="submit" value="Print Asc" name="printa" class="button" />
</td>
</tr>
</table>
</form>
