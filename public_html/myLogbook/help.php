...
Print Asc will print your logbook from the earliest date to the most recent.<br/>
Print Desc will print in descending order from the most recent date to the earliest date.<br/>
</p>
</td></tr></table>
