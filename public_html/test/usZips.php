...
<?php
printf("	xmlhttp.open('POST', 'getCities.php?state=' + state.options[state.selectedIndex].text + '&city=' + '&id=%s', false);\r\n", $sess->sessionId);
?>
	xmlhttp.send();
}
...
<?php
printf("	xmlhttp.open('POST', 'getZipcodes.php?state=' + state.options[state.selectedIndex].text + '&city=' + city.options[city.selectedIndex].text + '&id=%s', false);\r\n", $sess->sessionId);
?>
	xmlhttp.send();
}
...
<?php printf("	xmlhttp.open('POST', 'getCounties.php?state=' + state.options[state.selectedIndex].text + '&city=' + city.options[city.selectedIndex].text + '&zip=' + zip.options[zip.selectedIndex].text + '&id=%s', false);\r\n", $sess->sessionId);
?>
	xmlhttp.send();
}
</script>
